...
if($_POST['act'] == 'req'.$idpost):
    ...
    $whyreview = htmlentities($whyreview);
    $datesavailable = htmlentities($datesavailable);
    $contactname = htmlentities($contactname);
    $contactemail = htmlentities($contactemail);
    
    $message = 'Name of project: '.$projectname.
    			', Description of project : '.$description.
    			', Why does it need an ethics committee review?: '.$whyreview.
    			', Available dates for review: '.$datesavailable.
