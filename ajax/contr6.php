...
if($_POST['act'] == 'contr'.$idpost):
    ...
    $projectdescription = htmlentities($projectdescription);
    $awardingbody = htmlentities($awardingbody);
    $projectdate = htmlentities($projectdate);
    $projectduration = htmlentities($projectduration);
    $projectfunding = htmlentities($projectfunding);
    ...
    $message = 'Project description: '.$projectdescription.
    			...
    			',Start date of project: '.$projectdate.
    			',Duration of project: '.$projectduration.
    			',Funding of project: '.$projectfunding.
