...
<body id="page-top" class="index">
	...
	<header>
		<div class="container">
			<div class="intro-text">
				...
				<a href="#pillars" class="page-scroll btn btn-xl">How we can help </a>
			</div>
		</div>
	</header>
		...
		<div class="container" class="bg-light-gray">
			<div class="row">
				<div class="col-lg-12 text-center">
					<h2 class="section-heading">Pillars of Engagement</h2>
					<h3 class="section-subheading text-muted">Pillars .... Pillars ...
						Pillars!!!</h3>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a href="#education" class="portfolio-link page-scroll"> <img
						src="img/Education_Chalkboard.jpg" class="img-responsive" alt="">
					</a>
					<div class="portfolio-caption">
						<h4>Education</h4>
						<p class="text-muted">Li Europan lingues es membres del sam
							familie. Lor separat existentie es un myth. Por scientie, musica,
							sport etc, litot</p>
					</div>
				</div>
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a href="#portfolio" class="portfolio-link page-scroll"> <img
						src="img/research.jpg" class="img-responsive" alt="">
					</a>
					<div class="portfolio-caption">
						<h4>Research</h4>
						<p class="text-muted">Li Europan lingues es membres del sam
				...
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a href="#endowment" class="portfolio-link page-scroll"> <img
						src="img/endowments.jpg" class="img-responsive" alt="">
					</a>
					<div class="portfolio-caption">
						<h4>Endowments</h4>
						<p class="text-muted">Li Europan lingues es membres del sam
	...
	<!-- Services Section -->
	<section id="education" class="bg-light-grey">
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
			...
			<div class="row">
				<div class="col-md-4">
					<a href="#educationModal1" class="portfolio-link"
						style="text-decoration: none" data-toggle="modal"> <span
						class="fa-stack fa-4x"> <i
							class="fa fa-circle fa-stack-2x text-primary"></i> <i
							class="fa fa-mortar-board fa-stack-1x fa-inverse"></i>
					</span>
						<h4 class="service-heading">Open Enrolment</h4>
				...
				<div class="col-md-4">
					<a href="#educationModal2" class="portfolio-link"
						style="text-decoration: none" data-toggle="modal"> <span
						class="fa-stack fa-4x"> <i
							class="fa fa-circle fa-stack-2x text-primary"></i> <i
							class="fa fa-cog fa-spin fa-stack-1x fa-inverse"></i>
					</span>
						<h4 class="service-heading">Custom Courses</h4>
				...
				<div class="col-md-4">
					<a href="#educationModal3" class="portfolio-link"
						style="text-decoration: none" data-toggle="modal"> <span
						class="fa-stack fa-4x"> <i
							class="fa fa-circle fa-stack-2x text-primary"></i> <i
							class="fa fa-rupee fa-stack-1x fa-inverse"></i>
					</span>
						<h4 class="service-heading">Hiring</h4>
			...
			<div class="row">
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a href="#portfolioModal1" class="portfolio-link"
						...
						</div> <img src="img/portfolio/faculty.png" class="img-responsive"
						alt="">
					</a>
					<div class="portfolio-caption">
						<h4>Nurture-an-Area</h4>
				...
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a href="#portfolioModal3" class="portfolio-link"
						...
						</div> <img src="img/portfolio/student.png" class="img-responsive"
						alt="">
					</a>
					<div class="portfolio-caption">
						<h4>Tech Transfer/Licensing</h4>
						<p class="text-muted">Lorem ipsum dolor sit amet, consectetuer
							adipiscing elit. Aenean commodo ligula eget</p>
					</div>
				</div>
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a href="#portfolioModal4" class="portfolio-link"
						...
						</div> <img src="img/portfolio/startup-framework-preview.png"
						class="img-responsive" alt="">
					</a>
					<div class="portfolio-caption">
						<h4>Set up a Lab</h4>
				...
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a href="#portfolioModal5" class="portfolio-link"
						...
						</div> <img src="img/portfolio/treehouse-preview.png"
						class="img-responsive" alt="">
					</a>
					<div class="portfolio-caption">
	...
	<!-- About Section -->
	<section id="endowment" class="bg-light-grey">
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					<h2 class="section-heading">Endowments</h2>
					<h3 class="section-subheading text-muted">How you can help our
						institute</h3>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4 col-sm-6 endowment-item">
					<a href="#portfolioModal1" class="endowment-link"
						data-toggle="modal">
						<div class="endowment-hover">
							<div class="endowment-hover-content">
								<i class="fa fa-plus fa-3x"></i>
							</div>
						</div> <img src="img/portfolio/Endowments - Donate.jpg" class="img-responsive"
						alt="">
					</a>
					<div class="endowment-caption">
						<h4>Donation</h4>
						<p class="text-muted">Lorem ipsum dolor sit amet, consectetuer
							adipiscing elit. Aenean commodo ligula eget</p>
					</div>
				...
				<div class="col-md-4 col-sm-6 endowment-item">
					<a href="#portfolioModal2" class="endowment-link"
						data-toggle="modal">
						<div class="endowment-hover">
							<div class="endowment-hover-content">
								<i class="fa fa-plus fa-3x"></i>
							</div>
						</div> <img src="img/portfolio/Endowments - Faculty Chair.jpg"
						class="img-responsive" alt="">
					</a>
					<div class="endowment-caption">
						<h4>Faculty Chair</h4>
				...
				<div class="col-md-4 col-sm-6 endowment-item">
					<a href="#portfolioModal3" class="endowment-link"
						data-toggle="modal">
						<div class="endowment-hover">
							<div class="endowment-hover-content">
								<i class="fa fa-plus fa-3x"></i>
							</div>
						</div> <img src="img/portfolio/Endowments - Infrastructure.jpg" class="img-responsive"
						alt="">
					</a>
					<div class="endowment-caption">
				...
				<div class="col-md-4 col-sm-6 endowment-item">
					<a href="#portfolioModal4" class="endowment-link"
						data-toggle="modal">
						<div class="endowment-hover">
							<div class="endowment-hover-content">
								<i class="fa fa-plus fa-3x"></i>
							</div>
						</div> <img src="img/portfolio/Endowments - Scholarship.jpg"
						class="img-responsive" alt="">
					</a>
					<div class="endowment-caption">
						<h4>Scholarships</h4>
				...
				<div class="col-md-4 col-sm-6 endowment-item">
					<a href="#portfolioModal5" class="endowment-link"
						data-toggle="modal">
						<div class="endowment-hover">
							<div class="endowment-hover-content">
								<i class="fa fa-plus fa-3x"></i>
							</div>
						</div> <img src="img/portfolio/Endowments - Travel Grants.jpg"
						class="img-responsive" alt="">
					</a>
					<div class="endowment-caption">
						<h4>Travel Grants</h4>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					...
					<h3 class="section-subheading text-muted">Download following links</h3>
						...
						<div class="modal-body">
							...
							<div class="panel-group" id="accordion1">
								<div class="panel panel-default">
									<div class="panel-heading">
										<a class="accordion-toggle" data-toggle="collapse"
											data-parent="#accordion" href="#1collapseOne">
											<h4 class="panel-title">Collapsible Group Item #1</h4>
										</a>
									</div>
									<div id="1collapseOne" class="panel-collapse collapse in">
								...
								<div class="panel panel-default">
									<div class="panel-heading">
										<a class="accordion-toggle" data-toggle="collapse"
											data-parent="#accordion" href="#1collapseTwo">
											<h4 class="panel-title">Collapsible Group Item #2</h4>
										</a>
									</div>
									<div id="1collapseTwo" class="panel-collapse collapse">
										<div class="panel-body">Anim pariatur cliche reprehenderit,
											enim eiusmod high life accusamus terry richardson ad squid. 3
											wolf moon officia aute, non cupidatat skateboard dolor
											brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3
								...
								<div class="panel panel-default">
									<div class="panel-heading">
										<a class="accordion-toggle" data-toggle="collapse"
											data-parent="#accordion" href="#1collapseThree">
											<h4 class="panel-title">Collapsible Group Item #3</h4>
										</a>
									</div>
									<div id="1collapseThree" class="panel-collapse collapse">
										<div class="panel-body">Anim pariatur cliche reprehenderit,
											enim eiusmod high life accusamus terry richardson ad squid. 3
											wolf moon officia aute, non cupidatat skateboard dolor
											brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3
						...
						<div class="modal-body">
							...
							<div class="panel-group" id="accordion2">
								<div class="panel panel-default">
									<div class="panel-heading">
										<a class="accordion-toggle" data-toggle="collapse"
											data-parent="#accordion" href="#2collapseOne">
											<h4 class="panel-title">Collapsible Group Item #1</h4>
										</a>
									</div>
									<div id="2collapseOne" class="panel-collapse collapse in">
										<div class="panel-body">Anim pariatur cliche reprehenderit,
											enim eiusmod high life accusamus terry richardson ad squid. 3
											wolf moon officia aute, non cupidatat skateboard dolor
											brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3
								...
								<div class="panel panel-default">
									<div class="panel-heading">
										<a class="accordion-toggle" data-toggle="collapse"
											data-parent="#accordion" href="#2collapseTwo">
											<h4 class="panel-title">Collapsible Group Item #2</h4>
										</a>
									</div>
									<div id="2collapseTwo" class="panel-collapse collapse">
										<div class="panel-body">Anim pariatur cliche reprehenderit,
											enim eiusmod high life accusamus terry richardson ad squid. 3
											wolf moon officia aute, non cupidatat skateboard dolor
											brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3
								...
								<div class="panel panel-default">
									<div class="panel-heading">
										<a class="accordion-toggle" data-toggle="collapse"
											data-parent="#accordion" href="#2collapseThree">
											<h4 class="panel-title">Collapsible Group Item #3</h4>
										</a>
									</div>
									<div id="2collapseThree" class="panel-collapse collapse">
										<div class="panel-body">Anim pariatur cliche reprehenderit,
											enim eiusmod high life accusamus terry richardson ad squid. 3
											wolf moon officia aute, non cupidatat skateboard dolor
											brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3
							...
							<div class="panel-group" id="accordion3">
								<div class="panel panel-default">
									<div class="panel-heading">
										<h4 class="panel-title">
											<a class="accordion-toggle" data-toggle="collapse"
												data-parent="#accordion" href="#3collapseOne"> Collapsible
												Group Item #1 </a>
										</h4>
									</div>
									<div id="3collapseOne" class="panel-collapse collapse in">
										<div class="panel-body">Anim pariatur cliche reprehenderit,
											enim eiusmod high life accusamus terry richardson ad squid. 3
											wolf moon officia aute, non cupidatat skateboard dolor
											brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3
								...
								<div class="panel panel-default">
									<div class="panel-heading">
										<h4 class="panel-title">
											<a class="accordion-toggle" data-toggle="collapse"
												data-parent="#accordion" href="#3collapseTwo"> Collapsible
												Group Item #2 </a>
										</h4>
									</div>
									<div id="3collapseTwo" class="panel-collapse collapse">
										<div class="panel-body">Anim pariatur cliche reprehenderit,
											enim eiusmod high life accusamus terry richardson ad squid. 3
											wolf moon officia aute, non cupidatat skateboard dolor
											brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3
								...
								<div class="panel panel-default">
									<div class="panel-heading">
										<h4 class="panel-title">
											<a class="accordion-toggle" data-toggle="collapse"
												data-parent="#accordion" href="#3collapseThree"> Collapsible
												Group Item #3 </a>
										</h4>
									</div>
									<div id="3collapseThree" class="panel-collapse collapse">
										<div class="panel-body">Anim pariatur cliche reprehenderit,
											enim eiusmod high life accusamus terry richardson ad squid. 3
											wolf moon officia aute, non cupidatat skateboard dolor
											brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3
