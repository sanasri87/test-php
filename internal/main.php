...
<body id="page-top" class="index">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-3 col-sm-3">
					<a href="#requestModal1" data-toggle="modal"> <img
						src="../img/request.png" class="img-rounded" alt="Rounded Image">
					</a>
				</div>
				<div class="col-md-3 col-sm-3">
					<a href="#requestModal2" data-toggle="modal"> <img
						src="../img/request.png" class="img-rounded" alt="Rounded Image">
					</a>
				</div>
				<div class="col-md-3 col-sm-3">
					<a href="#requestModal3" data-toggle="modal"> <img
						src="../img/request.png" class="img-rounded" alt="Rounded Image">
					</a>
				</div>
				<div class="col-md-3 col-sm-3">
					<a href="#requestModal4" data-toggle="modal"> <img
						src="../img/request.png" class="img-rounded" alt="Rounded Image">
					</a>
				</div>
				<div class="col-md-3 col-sm-3">
					<a href="#requestModal5" data-toggle="modal"> <img
						src="../img/request.png" class="img-rounded" alt="Rounded Image">
					</a>
				</div>
				<div class="col-md-3 col-sm-3">
					<a href="#requestModal6" data-toggle="modal"> <img
						src="../img/request.png" class="img-rounded" alt="Rounded Image">
					</a>
				</div>
				<div class="col-md-3 col-sm-3">
					<a href="#requestModal7" data-toggle="modal"> <img
						src="../img/request.png" class="img-rounded" alt="Rounded Image">
					</a>
				</div>
				<div class="col-md-3 col-sm-3">
					<a href="#requestModal8" data-toggle="modal"> <img
						src="../img/request.png" class="img-rounded" alt="Rounded Image">
					</a>
				</div>
				<div class="col-md-3 col-sm-3">
					<a href="#requestModal9" data-toggle="modal"> <img
						src="../img/request.png" class="img-rounded" alt="Rounded Image">
					</a>
				</div>
				<div class="col-md-3 col-sm-3">
					<a href="#requestModal10" data-toggle="modal"> <img
						src="../img/request.png" class="img-rounded" alt="Rounded Image">
					</a>
				</div>
				<div class="col-md-3 col-sm-3">
					<a href="#requestModal11" data-toggle="modal"> <img
						src="../img/request.png" class="img-rounded" alt="Rounded Image">
					</a>
				</div>
				<div class="col-md-3 col-sm-3">
					<a href="#requestModal12" data-toggle="modal"> <img
						src="../img/request.png" class="img-rounded" alt="Rounded Image">
					</a>
				</div>
				<div class="col-md-3 col-sm-3">
					<a href="#requestModal13" data-toggle="modal"> <img
						src="../img/request.png" class="img-rounded" alt="Rounded Image">
					</a>
				</div>
				<div class="col-md-3 col-sm-3">
					<a href="#requestModal14" data-toggle="modal"> <img
						src="../img/request.png" class="img-rounded" alt="Rounded Image">
					</a>
				</div>
					...
					<div class="row">
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								...
								<!-- <h2 class="header">Select achievement type</h2> -->

								<!-- 								<div class="togglable-tabs tabs-left" id="yw44"><ul id="yw45" class="nav nav-tabs"><li class=""><a data-toggle="tab" href="#yw44_tab_1">Section 1</a></li><li class=""><a data-toggle="tab" href="#yw44_tab_2">Section 2</a></li><li class=""><a data-toggle="tab" href="#yw44_tab_3">Section 3</a></li></ul><div class="tab-content"><div id="yw44_tab_1" class="tab-pane fade "><p>I'm in Section 1.</p></div><div id="yw44_tab_2" class="tab-pane fade"><p>Howdy, I'm in Section 2.</p></div><div id="yw44_tab_3" class="tab-pane fade"><p>What up girl, this is Section 3.</p></div></div></div> -->

								<div class="row clearfix">
									<div class="col-md-4 column">
										<div class="btn-group-vertical">
											<button type="button" class="btn btn-default" id="ach1">Publications</button>
											<button type="button" class="btn btn-default" id="ach2">Commercializable
												technology</button>
											<button type="button" class="btn btn-default" id="ach3">Media
												mention</button>
											<button type="button" class="btn btn-default" id="ach4">Awards</button>
											<button type="button" class="btn btn-default" id="ach5">Milestones</button>
											<button type="button" class="btn btn-default" id="ach6">New
												funding</button>
											<button type="button" class="btn btn-default" id="ach7">Participation
												in Committees</button>
											<button type="button" class="btn btn-default" id="ach8">Books</button>
											<button type="button" class="btn btn-default" id="ach9">Conferences</button>
										</div>
									</div>

									<div class="col-md-8 column" style="padding-left: 50px;">
										<div class="form-class" id="form1">
					...
					<div class="row">
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								<!-- Project Details Go Here -->
								<h2>
									<legend style="border-bottom: 0px;">Ethics Committee Review</legend>
								</h2>
								<p class="item-intro text-muted">Lorem ipsum dolor sit amet
									consectetur.</p>
	...
	<!---------------------- Request Modal ---------------->
	<div class="portfolio-modal modal fade" id="requestModal2"
		tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-content">
			<div class="close-modal" data-dismiss="modal">
				<div class="lr">
					...
					<div class="row">
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								<!-- Project Details Go Here -->
								<h2>
									<legend style="border-bottom: 0px;"> Research Proposal Review </legend>
								</h2>
								<p class="item-intro text-muted">Lorem ipsum dolor sit amet
									consectetur.</p>
	...
	<!---------------------- Request Modal ---------------->
	<div class="portfolio-modal modal fade" id="requestModal3"
		tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-content">
			<div class="close-modal" data-dismiss="modal">
				<div class="lr">
					...
					<div class="row">
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								<!-- Project Details Go Here -->
								<h2>
									<legend style="border-bottom: 0px;">UC Request</legend>
								</h2>
								<p class="item-intro text-muted">Lorem ipsum dolor sit amet
									consectetur.</p>
	...
	<!---------------------- Request Modal ---------------->
	<div class="portfolio-modal modal fade" id="requestModal4"
		tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-content">
			<div class="close-modal" data-dismiss="modal">
				<div class="lr">
					...
					<div class="row">
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								<!-- Project Details Go Here -->
								<h2>
									<legend style="border-bottom: 0px;">New employee request </legend>
								</h2>
								<p class="item-intro text-muted">Lorem ipsum dolor sit amet
									consectetur.</p>
								<form class="form-horizontal" id="reqform4">
									<fieldset>
										...
										<!-- File Button -->
										<div class="form-group">
											<label class="col-md-4 control-label" for="files">Employee
												resume</label>
											<div class="col-md-4">
												<input id="files" name="files" class="input-file"
													type="file">
											</div>
										</div>
	...
	<!---------------------- Request Modal ---------------->
	<div class="portfolio-modal modal fade" id="requestModal5"
		tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-content">
			<div class="close-modal" data-dismiss="modal">
				<div class="lr">
					...
					<div class="row">
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								<!-- Project Details Go Here -->
								<h2>
									<legend style="border-bottom: 0px;">Employee termination
										request</legend>
								</h2>
								<p class="item-intro text-muted">Lorem ipsum dolor sit amet
									consectetur.</p>
	...
	<!---------------------- Request Modal ---------------->
	<div class="portfolio-modal modal fade" id="requestModal6"
		tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-content">
			<div class="close-modal" data-dismiss="modal">
				<div class="lr">
					...
					<div class="row">
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								<!-- Project Details Go Here -->
								<h2>
									<legend style="border-bottom: 0px;">Purchase technical
										equipment request </legend>
								</h2>
								<p class="item-intro text-muted">Lorem ipsum dolor sit amet
									consectetur.</p>
	...
	<!---------------------- Request Modal ---------------->
	<div class="portfolio-modal modal fade" id="requestModal7"
		tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-content">
			<div class="close-modal" data-dismiss="modal">
				<div class="lr">
					...
					<div class="row">
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								<!-- Project Details Go Here -->
								<h2>
									<legend style="border-bottom: 0px;">Purchase non-technical
										equipment request </legend>
								</h2>
								<p class="item-intro text-muted">Lorem ipsum dolor sit amet
									consectetur.</p>
	...
	<!---------------------- Request Modal ---------------->
	<div class="portfolio-modal modal fade" id="requestModal8"
		tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-content">
			<div class="close-modal" data-dismiss="modal">
				<div class="lr">
					...
					<div class="row">
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								<!-- Project Details Go Here -->
								<h2>
									<legend style="border-bottom: 0px;">Handover technical
										equipment request </legend>
								</h2>
								<p class="item-intro text-muted">Lorem ipsum dolor sit amet
									consectetur.</p>
	...
	<!---------------------- Request Modal ---------------->
	<div class="portfolio-modal modal fade" id="requestModal9"
		tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-content">
			<div class="close-modal" data-dismiss="modal">
				<div class="lr">
					...
					<div class="row">
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								<!-- Project Details Go Here -->
								<h2>
									<legend style="border-bottom: 0px;">Handover non-technical
										equipment request</legend>
								</h2>
								<p class="item-intro text-muted">Lorem ipsum dolor sit amet
									consectetur.</p>
	...
	<!---------------------- Request Modal ---------------->
	<div class="portfolio-modal modal fade" id="requestModal10"
		tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-content">
			<div class="close-modal" data-dismiss="modal">
				<div class="lr">
					...
					<div class="row">
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								<!-- Project Details Go Here -->
								<h2>
									<legend style="border-bottom: 0px;">Space request </legend>
								</h2>
								<p class="item-intro text-muted">Lorem ipsum dolor sit amet
									consectetur.</p>
	...
	<!---------------------- Request Modal ---------------->
	<div class="portfolio-modal modal fade" id="requestModal11"
		tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-content">
			<div class="close-modal" data-dismiss="modal">
				<div class="lr">
					...
					<div class="row">
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								<!-- Project Details Go Here -->
								<h2>
									<legend style="border-bottom: 0px;">Space handover </legend>
								</h2>
								<p class="item-intro text-muted">Lorem ipsum dolor sit amet
									consectetur.</p>
	...
	<!---------------------- Request Modal ---------------->
	<div class="portfolio-modal modal fade" id="requestModal12"
		tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-content">
			<div class="close-modal" data-dismiss="modal">
				<div class="lr">
					...
					<div class="row">
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								<!-- Project Details Go Here -->
								<h2>
									<legend style="border-bottom: 0px;">Travel Request </legend>
								</h2>
								<p class="item-intro text-muted">Lorem ipsum dolor sit amet
									consectetur.</p>
	...
	<!---------------------- Request Modal ---------------->
	<div class="portfolio-modal modal fade" id="requestModal13"
		tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-content">
			<div class="close-modal" data-dismiss="modal">
				<div class="lr">
					...
					<div class="row">
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								<!-- Project Details Go Here -->
								<h2>
									<legend style="border-bottom: 0px;">Scholarship Request</legend>
								</h2>
								<p class="item-intro text-muted">Lorem ipsum dolor sit amet
									consectetur.</p>
								<form class="form-horizontal" id="reqform13">
									<fieldset>
										...
										<!-- File Button -->
										<div class="form-group">
											<label class="col-md-4 control-label" for="files">Student
												Resume</label>
											<div class="col-md-4">
												<input id="files" name="files" class="input-file"
													type="file">
	...
	<!---------------------- Request Modal ---------------->
	<div class="portfolio-modal modal fade" id="requestModal14"
		tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-content">
			<div class="close-modal" data-dismiss="modal">
				<div class="lr">
					...
					<div class="row">
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								<!-- Project Details Go Here -->
								<h2>
									<legend style="border-bottom: 0px;">Visa Supporting Documents
										Request </legend>
								</h2>
								<p class="item-intro text-muted">Lorem ipsum dolor sit amet
									consectetur.</p>
